...
namespace SSTUTools
{
	public class NodeFairingGenerator : BasicFairingGenerator
	{
		
		public NodeFairingGenerator(float startHeight, float boltPanelHeight, float totalPanelHeight, float maxPanelSectionHeight, float bottomRadius, 
