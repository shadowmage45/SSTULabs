Shader "SSTU/MaskedReflective"
{
	...
	SubShader
	{
		...
		void surf (Input IN, inout ColoredSpecularSurfaceOutput o)
		{
            ...
            half3 emission = stockEmit(IN.viewDir, normal, _RimColor, _RimFalloff, _TemperatureColor) * _Opacity;
            
            float3 worldRefl = WorldReflectionVector(IN, o.Normal);
            fixed4 reflcol = texCUBE(_Cube, worldRefl);
            fixed3 reflection = spec.a * reflcol;
			
			o.Albedo = saturate(userColor + diffuseColor + detailColor) * ao;			
			o.GlossColor = saturate(userSpec + baseSpec + detailSpec);
			o.Specular = _Shininess;
			o.Normal = normal;
			o.Emission = emission + reflection;
			o.Alpha = _Opacity;
		}
		ENDCG
	}
