Shader "SSTU/Emissive"
{
	Properties 
	{
        ...
        _EmissiveColor("_Emission", Color) = (0,0,0,0)
	}
	...
	SubShader
	{
		...
		void surf (Input IN, inout ColoredSpecularSurfaceOutput o)
		{
			...
			o.Normal = normal;
			o.Emission = stockEmit(IN.viewDir, normal, _RimColor, _RimFalloff, _TemperatureColor) * _Opacity + (tex2D(_Emissive, IN.uv_MainTex).rgb * _EmissiveColor.rgb) * _EmissiveColor.a;;
			o.Alpha = _Opacity;
		}
		ENDCG
	}
